...
<head>
    ...
    <link rel="stylesheet" href="assets/styles/etp.css">
...
<main>
        <section class="etp-hero">
            <img src="assets/images/etp/etp-bg.png" class="etp-bg">
            <div class="etp-content container">
                <h1 class="h1-white etp-h1">ЕТП Робототехника</h1>
                <div class="etp-hero__logos">
                    <a href="https://eec.eaeunion.org" target="_blank"><img src="assets/images/etp/eek-logo.png"></a>
        ...
        <section class="container etp-tasks">
            ...
            <div class="row">
                <div class="col">
                    <img src="assets/images/etp/card-1.png" alt="Рукопожатие - изображение сгенерировано нейросетью | Консорциум Робототехники">
                ...
                <div class="col">
                    <img src="assets/images/etp/card-2.png" alt="Аналитика - изображение сгенерировано нейросетью | Консорциум Робототехники">
                ...
                <div class="col">
                    <img src="assets/images/etp/card-3.png" alt="Робо-рука - изображение сгенерировано нейросетью | Консорциум Робототехники">
        ...
        <section class="container etp-participants">
            ...
            <div class="etp-participants__card row">
                <img src="assets/images/header/crb_logo_header.png" alt="Консорциум робототехники и систем интеллектуального управления логотип | Консорциум Робототехники" class="col-3">
                <div class="col-1"></div>
            ...
            <div class="etp-participants__card row">
                <img src="assets/images/etp/ara-logo.png" alt="Общественная организация «Ассоциация робототехники Армении» логотип | Консорциум Робототехники" class="col-3">
                <div class="col-1"></div>
                <div class="col etp-participants__card__texts">
            ...
            <div class="etp-participants__card row">
                <img src="assets/images/etp/rai-logo.png" alt="Ассоциация «Робототехника и искусственный интеллект» логотип | Консорциум Робототехники" class="col-3">
                <div class="col-1"></div>
                <div class="col etp-participants__card__texts">
            ...
            <div class="etp-participants__card row">
                <img src="assets/images/etp/kaar-logo.png" alt="Объединение юридических лиц «Казахстанская ассоциация автоматизации и робототехники» логотип | Консорциум Робототехники" class="col-3">
                <div class="col-1"></div>
                <div class="col etp-participants__card__texts">
            ...
            <div class="etp-participants__card row">
                <img src="assets/images/etp/kgtu-logo.png" alt="Кыргызский государственный технический университет им. И. Раззакова логотип | Консорциум Робототехники" class="col-3">
                <div class="col-1"></div>
                <div class="col etp-participants__card__texts">
            ...
            <div class="etp-participants__card row">
                <img src="assets/images/etp/krsu-logo.png" alt="Кыргызско-Российский Славянский университет имени первого Президента Российской Федерации Б.Н. Ельцина логотип | Консорциум Робототехники" class="col-3">
                <div class="col-1"></div>
                <div class="col etp-participants__card__texts">
