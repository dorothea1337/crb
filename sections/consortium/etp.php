...
<main>
        <section class="etp-hero">
            <div class="etp-content container">
                ...
                <div class="etp-hero__logos">
                    <a href="https://eec.eaeunion.org" target="_blank"><img src="<?= BASE_URL ?>assets/images/etp/eek-logo.png" class="etp__eek-logo"></a>
        ...
        <section class="container">
            ...
            <div class="etp-tasks">
                <div class="etp-tasks__card">
                    <img src="<?= BASE_URL ?>assets/images/etp/card-1.png" alt="Рукопожатие - изображение сгенерировано нейросетью | Консорциум Робототехники" class="etp-tasks__img">
                ...
                <div class="etp-tasks__card">
                    <img src="<?= BASE_URL ?>assets/images/etp/card-2.png" alt="Аналитика - изображение сгенерировано нейросетью | Консорциум Робототехники" class="etp-tasks__img">
                ...
                <div class="etp-tasks__card">
                    <img src="<?= BASE_URL ?>assets/images/etp/card-3.png" alt="Робо-рука - изображение сгенерировано нейросетью | Консорциум Робототехники" class="etp-tasks__img">
        ...
        <section class="container etp-participants">
            ...
            <div class="etp-participants__card">
                <img src="<?= BASE_URL ?>assets/images/header/crb_logo_header.svg" alt="Консорциум робототехники и систем интеллектуального управления логотип | Консорциум Робототехники" class="etp-participant__logo">
            ...
            <div class="etp-participants__card">
                <img src="<?= BASE_URL ?>assets/images/etp/rai-logo.png" alt="Ассоциация «Робототехника и искусственный интеллект» логотип | Консорциум Робототехники" class="etp-participant__logo">
                <div class="etp-participants__card__texts">
            ...
            <div class="etp-participants__card">
                <img src="<?= BASE_URL ?>assets/images/etp/kaar-logo.png" alt="Объединение юридических лиц «Казахстанская ассоциация автоматизации и робототехники» логотип | Консорциум Робототехники" class="etp-participant__logo">
                <div class="etp-participants__card__texts">
            ...
            <div class="etp-participants__card">
                <img src="<?= BASE_URL ?>assets/images/etp/kgtu-logo.png" alt="Кыргызский государственный технический университет им. И. Раззакова логотип | Консорциум Робототехники" class="etp-participant__logo">
                <div class="etp-participants__card__texts">
            ...
            <div class="etp-participants__card">
                <img src="<?= BASE_URL ?>assets/images/etp/krsu-logo.png" alt="Кыргызско-Российский Славянский университет имени первого Президента Российской Федерации Б.Н. Ельцина логотип | Консорциум Робототехники" class="etp-participant__logo">
                <div class="etp-participants__card__texts">
